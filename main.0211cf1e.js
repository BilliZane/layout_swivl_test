...
navItems.forEach(function (li) {
  li.addEventListener('click', function () {
    var item = document.querySelector('.header__nav-item--active');
...
var showModalBtn = document.querySelector('#open-info-btn');
var modal = document.querySelector('#modal');
showModalBtn.addEventListener('click', function () {
  modal.classList.toggle('card__modal--show');
});
body.addEventListener('click', function (event) {
  if (event.target.classList.value !== 'card__open-info') {
    modal.classList.remove('card__modal--show');
  }
}); // END OF .card__modal
},{}]},{},["KIzB"], null)
//# sourceMappingURL=main.0211cf1e.js.map